...
from run_architecture import Architecture
from Save_Load_Data.save_load_data import save_models, load_models
...
if __name__ == '__main__':
    ...
    # Datasets setting
    data_dir = '../DataSets'
    Datasets = ['MSR_Action3D_1', 'MSR_Action3D_2', 'MSR_Action3D_all']
    Dataset = Datasets[1]
    ...
    if make_data_split:
        ...
        InputData = load_models(datasplit_to_load)
    ...
    if Stage is 'Training':
        ...
        for seed in range(rs.nbr_fold):
            ...
            arc = Architecture(input_dim=pose_dim,
    ...
    if Stage is 'Testing':
        model_name = 'MSR_Action3D_2_SOM_SOM_start_time_'
        models_to_load = '../trained_models/{}/{}.pickle'.format(Dataset, model_name)
        models = load_models(models_to_load)
